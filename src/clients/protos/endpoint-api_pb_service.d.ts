...
type EndpointServiceGetAllDeployment = {
  readonly methodName: string;
  readonly service: typeof EndpointService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof endpoint_api_pb.GetAllDeploymentRequest;
  readonly responseType: typeof endpoint_api_pb.GetAllDeploymentResponse;
};
...
export class EndpointService {
  ...
  static readonly GetAllDeployment: EndpointServiceGetAllDeployment;
...
export class EndpointServiceClient {
  ...
  getAllDeployment(
    requestMessage: endpoint_api_pb.GetAllDeploymentRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: endpoint_api_pb.GetAllDeploymentResponse|null) => void
  ): UnaryResponse;
  getAllDeployment(
    requestMessage: endpoint_api_pb.GetAllDeploymentRequest,
    callback: (error: ServiceError|null, responseMessage: endpoint_api_pb.GetAllDeploymentResponse|null) => void
