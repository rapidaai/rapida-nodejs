...
EndpointService.GetAllDeployment = {
  methodName: "GetAllDeployment",
  service: EndpointService,
  requestStream: false,
  responseStream: false,
  requestType: endpoint_api_pb.GetAllDeploymentRequest,
  responseType: endpoint_api_pb.GetAllDeploymentResponse
};
...
EndpointServiceClient.prototype.getAllDeployment = function getAllDeployment(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(EndpointService.GetAllDeployment, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
